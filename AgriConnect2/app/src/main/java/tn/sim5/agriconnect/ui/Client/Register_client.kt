...
import tn.sim5.agriconnect.databinding.ActivityRegisterClientBinding
import tn.sim5.agriconnect.databinding.ActivitySignUpBinding


class Register_client : AppCompatActivity() {

    private lateinit var viewModel: ClientSignUp
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(ClientSignUp::class.java)
    ...
    private fun validateAndSignUp() {
        ...
        when {
            ...
            password.length < 6 || !isValidPassword(password) -> {
                ...
                viewModel.signUpClient(name, email, password, numTel)
