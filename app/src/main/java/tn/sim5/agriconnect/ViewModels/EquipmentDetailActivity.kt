...
import tn.sim5.agriconnect.ui.MaintenanceActivity
...
class EquipmentDetailActivity : AppCompatActivity() {
    ...
    private fun updateEquipment(userId: String) {
        ...
        if (selectedImageUri != null) {
            ...
            imageRequestBody = RequestBody.create("image/*".toMediaTypeOrNull(), newImageFile)
        ...
        val categorieRequestBody = RequestBody.create("text/plain".toMediaTypeOrNull(), categorie)
        val etatRequestBody = RequestBody.create("text/plain".toMediaTypeOrNull(), etat)
    ...
    private fun addEquipment(userId: String) {
        ...
        val imagePart = MultipartBody.Part.createFormData("image", imageFile.name, RequestBody.create(
